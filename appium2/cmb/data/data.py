...
def readExcel(filePath,sheet, row, col):  #封装一个普通方法，用于读取excel表数据，readExcel是自定义的方法名
   ...
   # l_file = xlrd.open_workbook('C:\Users\Administrator.USER-20190920MY\Desktop\login.xlsx')
    l_file = xlrd.open_workbook(filePath)
...
print(curPath)
filePath=curPath+'\\data.xlsx'

print(readExcel(filePath,'data',1,1))